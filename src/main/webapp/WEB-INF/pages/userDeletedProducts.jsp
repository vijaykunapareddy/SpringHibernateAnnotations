...
<body>
	...
	<a href="getProductsExample">My Products List Example</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<center>
		<div style="color: teal; font-size: 30px">User Deleted List</div>
		<c:if test="${!empty rejectedList}">
			<table border="1" bgcolor="black" width="600px">
				...
				<c:forEach items="${rejectedList}" var="accepted">
					<tr
